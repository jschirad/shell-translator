  ...
  return (
    <header className="flex flex-col sm:flex-row sm:justify-between w-full pt-4 pb-8 px-2">
      <Link href="/" className="flex flex-col">
        <h1 className="font-mono sm:text-xl tracking-tight">Shell Translate</h1>
        <p className="font-mono font-bold text-gray-600">
          Human Language to Shell Translator
        </p>
      </Link>
      <div className="flex items-center gap-3 pt-4">
        ...
        <a
          ...
          href="https://github.com/jschirad"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/facundo-schirado/"
          rel="noopener noreferrer"
          target="_blank"
        >
          <div className="group " aria-label="Facu on Linkedin">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
